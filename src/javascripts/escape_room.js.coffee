angular.module('BB.Directives').directive 'escapeRoomClientDetails', () ->
  restrict: 'AE'
  replace: true
  scope : true
  controller : 'EscapeRoomClientDetails'

angular.module('BB.Controllers').controller 'EscapeRoomClientDetails', ($scope,  $rootScope, ClientDetailsService, ClientService, LoginService, BBModel, ValidatorService, QuestionService, AlertService) ->
